class CostSettings {
  ...
  CostSettings({
    ...
    this.bodyPlatePrice = 0,
    this.coverMaterialName = 'Suntalam (210x280 cm)',
    this.coverPlatePrice = 0,
    this.railPriceWhite = 0,
    this.railPriceTelescopic = 0,
    this.railPriceSmart = 0,
    this.hingePriceStop = 0,
    this.hingePriceNonStop = 0,
    this.handlePrice = 0,
    this.legPrice = 0,
    this.pvcPricePerMeter = 0,
    this.plateWidth = 210,
    this.plateHeight = 280,
  });
}